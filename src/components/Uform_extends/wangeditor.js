...
export default class Wangeditor extends React.Component {
    ...
    initEditor() {
        ...
        editor.create()
        this.props.disabled==true?editor.$textElem.attr('contenteditable', false):editor.$textElem.attr('contenteditable', true)
        
        this.editor.txt.html(this.props.value)
        if(this.props.commontablestore&&this.props.commontablestore.selectedRows.length!=0&&this.props.value==''){
