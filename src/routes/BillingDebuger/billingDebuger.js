            ...
            <div>
                ...
                <div style={{ width: '1230px', justifyContent: 'space-between', display: 'flex', paddingLeft: '20px' }}>
                    <div style={{ width: '160px' }}>
                        <Input style={{ width: '160' }} value={this.state.contractno} placeholder="请输入合同号,留空为所有"></Input>
                    </div>
                    ...
                    <Select showSearch style={{ width: 200 }} placeholder="选择周期" optionFilterProp="children" defaultValue={this.state.cycle} onChange={this.changeCycle}>
                    ...
                    <Select showSearch style={{ width: 200 }} placeholder="选择账期开关" optionFilterProp="children" defaultValue={this.state.cutoff} onChange={this.changeCutoff}>
                ...
                <div style={{ marginLeft: '20px' }}>
                    <Button type="primary" onClick={(event) => this.testibm()}>
                        计费模拟
                    </Button>
                </div>
