...
import { Form, Input, Divider, Card, Select, Radio, Row, Col, Button, message } from 'antd';
        ...
        this.props.form.validateFieldsAndScroll(async (err, values) => {
            if (!err) {
                ...
                if (this.dmstore.current_actcode === '') {
                    ...
                    obj = Object.assign({ 'reftype': 'sql', maintable: this.dmstore.maintable, act_name: this.dmstore.current_actname, act_code: this.dmstore.current_actcode }, values);
                    let params = {
                        data: obj,
                        method: 'POST'
                    };
        ...
        return (
            ...
            <div>
                ...
                <Card title="SQL说明" style={ { width: 1000 } }>
                    <div>在流程表单中,为了展示关系信息,有可能需要复杂的SQL进行展示,
