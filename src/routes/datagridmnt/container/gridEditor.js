            ...
            <Card title={ xtitle } style={ { width: "100%" } }>
                <Form onSubmit={ this.ModifyActionCode } >
                    ...
                    <Row>
                        ...
                        <Col span={ 4 }><Form.Item label="addurl">
                        ...
                        <Col span={ 4 }><Form.Item label="delurl">
                        ...
                        <Col span={ 4 }> <Form.Item label="updateurl">
                ...
                <div style={ { padding: "20px", marginBottom: "10px", border: "1px solid #343434" } }>
                    ...
                    <Row>
                        ...
                        <Col span={ 4 }>
                            ...
                            >
                                {
                                    this.dmstore.maintableColumns.length && this.dmstore.maintableColumns.map((item, index) => (
                        ...
                        <Col span={ 6 }>
                            <div style={ { marginBottom: '10px' } }> <Input onChange={ event => this.setQueryValue(event) } /></div>
                        </Col>
