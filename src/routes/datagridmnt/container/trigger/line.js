    ...
    render() {
        ...
        return (
            <div style={ { marginBottom: "10px" } }>
                <Row>
                    <Col span={ 2 }>
                        <Button type="default" btn_idx={ this.props.idx } onClick={ () => this.destroyLine(this.props.idx) }  >
                            删除
                        </Button>
                    </Col>
                    <Col span={ 4 }>
                    ...
                    <Col span={ 4 }>
                        ...
                        >
                            {
                                this.tgstore.refercolumns.length && this.tgstore.refercolumns.map((item, index) => (
