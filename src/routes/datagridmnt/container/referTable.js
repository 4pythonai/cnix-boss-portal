...
import { Form, Input, Divider, Card, Select, Row, Col, Radio, Button, message, TextArea, } from 'antd';
        ...
        this.props.form.validateFieldsAndScroll(async (err, values) => {
            if (!err) {
                if (this.dmstore.current_actcode === '') {
                    ...
                    let obj = {}
                    obj = Object.assign({ 'reftype': 'tableref', maintable: this.dmstore.maintable, act_name: this.dmstore.current_actname, act_code: this.dmstore.current_actcode }, values);
                    let params = {
                        data: obj,
                        method: 'POST'
                    };
