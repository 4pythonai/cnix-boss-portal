            ...
            <Row type="flex" justify="space-around" align="middle">
                ...
                <Col>
                    <Select style={{ width: '100px' }} onChange={this.onChangeSpeed} value={this.state.batch_portspeed || '请选择'}>
                        ...
                        <Select.Option key="GE" value="GE">
                            GE
                        </Select.Option>
                        <Select.Option key="XGE" value="XE">
                            XGE
                        </Select.Option>
                        <Select.Option key="10GE" value="10GE">
                            10GE
                        </Select.Option>
                        <Select.Option key="25GE" value="25GE">
                            25GE
                        </Select.Option>
                        <Select.Option key="40GE" value="40GE">
                            40GE
                        </Select.Option>
                        <Select.Option key="100GE" value="100GE">
                            100GE
                        </Select.Option>
                        <Select.Option key="200GE" value="200GE">
                            200GE
                        </Select.Option>
                    </Select>
                </Col>
    ...
    getNameSetter_double = () => {
        return (
            <Row type="flex" justify="center" align="middle">
                <Col>
                    L
                    <Select style={selectStyle} onChange={(value) => this.onChangePattern('double', value, 'n1')} value={this.state.Ndouble.n1}>
                        <Select.Option value="请选择">选择</Select.Option>
            ...
            <div style={lineWrapper} id="slider_template_wrapper">
                ...
                <div style={lineStyle}>
                    {this.state.ports.map((item) => (
                        <DevicePort className="devicePort" ref="devicePortRef" port={{ ...item }} key={item.inner_index} />
                    ))}
                </div>
            </div>
        );
