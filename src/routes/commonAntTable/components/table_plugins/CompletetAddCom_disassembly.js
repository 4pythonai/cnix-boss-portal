...
@observer
export default class CompletetAddCom_disassembly extends React.Component {
    state =
        {
            visible: true,
    ...
    render() {
        ...
        >
            ...
            <ReferpluginCom reportUUID={ this.reportUUID } reportOrginPaperno={ this.reportOrginPaperno } uploadfunction={ this.getCabinetsNotFinished } refer_actcode='pendtask_disassembly_response'
                infotitle='开工单详情'
                serviceurl="MIdcruntime/getDisassemblyDetail" />
            <br />
