                ...
                <div>
                    ...
                    {this.onlyShowTimeLine !== 'yes' ? (
                        <div>
                            ...
                            <Table dataSource={this.billjson.cycle_store} rowKey="id" columns={CycleItemColumns} pagination={false} size="small" expandedRowRender={this.expandedTime} />
                        </div>
                    ) : (
                        ''
                    )}
                    ...
                    <Table dataSource={this.billjson.contract_timeline} rowKey="counter" columns={TimeLineColumns} pagination={false} size="small" expandedRowRender={this.expandedLog} />
